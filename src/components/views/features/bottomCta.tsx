...
export const BottomCta = () => {
  return (
    <Wrapper className='!px-0 md:!px-content-sm lg:!px-content'>
      <div className='bg-card px-10 lg:px-16 py-14 md:py-20 md:rounded-2xl mb-5 space-y-5'>
        <h4 className='text-heading-h5 lg:w-[55%] font-semibold'>
        ...
        <div className='flex items-center gap-2 pt-4'>
          ...
          >
            <Link href='/pricing' className='flex items-end gap-2 text-sm'>
